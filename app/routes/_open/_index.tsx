    ...
    <div className="min-h-screen max-w-full flex flex-col pb-10">
      ...
      <div className="flex flex-row my-5 mx-auto container text-left items-center gap-12">
        <div className="flex flex-col w-1/2">
          <h1 className="font-secondary text-background-secondary text-6xl">
            Encontra a sua
          </h1>
          <h1 className="font-secondary text-background-secondary text-6xl">
            nova felicidade!
          ...
          <h3 className="text-lg font-medium mt-4 text-align">
            Na <strong>ADOPET</strong>, tornamos o processo de adoção de pets
            mais fácil, seguro e transparente, conectando adotantes a ONGs de
            confiança em todo o Brasil. Acreditamos que cada animal merece um
            lar cheio de carinho, e que cada pessoa merece a chance de encontrar
            um companheiro leal.
          </h3>
          <h3 className="text-lg font-medium mt-4 text-align">
            Navegue, conheça histórias e encontre aquele pet que vai transformar
            o seu dia a dia.{" "}
            <strong>
              Adotar é um ato de amor, e estamos aqui para garantir que ele
              aconteça do jeito certo.
            </strong>
          </h3>
      ...
      {isAuthenticated ? (
        ...
        <div className="overflow-visible w-full max-w-7xl mx-auto my-20">
          <h2 className="font-secondary text-5xl text-background-secondary text-center mb-10">
      ...
      <div className="flex mx-auto my-10">
        <h2 className="text-background-secondary font-secondary text-5xl">
          🤝 Apoie as ONGs parceiras
        </h2>
      </div>
      <div className="flex mx-auto my-5 w-200">
        <p className="text-lg text-center">
          Sua doação vai diretamente para as ONGs cadastradas na ADOPET,
          ajudando a manter o resgate, cuidado e adoção de animais em todo o
          Brasil. Contribua para que cada ONG continue salvando vidas e
      ...
      <div className="flex mx-auto">
        <p className="text-lg text-center">
          <strong>
            Seja parte dessa corrente do bem, doe e faça a diferença!
          </strong>
        </p>
      </div>
